...
class SetStatusAcceptCommand extends Command
{
    const ARG_ID              = 'id';
    const COMMAND_NAME        = 'etm:project:status-set-accept';
    const COMMAND_DESCRIPTION = 'Set project status to accept. Translations will be imported from Eurotext by cron.';
